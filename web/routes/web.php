...
// Route::get('shopify', 'UserDataController@GetProductData')->middleware(['verify.shopify']);

Route::get('/verifyStaffMember/{id?}/{shop?}', [StaffMemberController::class,'VerifyStaffMemberData']);
